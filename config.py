...
alt_tags_newborn = [
    ...
    "Family with newborn in car in Friedrichshafen", "Baby with bonnet in Singen", "Newborn with stuffed animal in Radolfzell",
    ...
    "Baby taking a bath in Friedrichshafen", "Neugeborenes mit Schnullerkette in Singen", "Newborn at dentist in Radolfzell",
    "Neugeborenes im Kinderbett in Konstanz", "Baby with rubber ducks in Kreuzlingen", "Neugeborenes im Hochstuhl in Rottweil",
    "Baby with teething ring in Schaffhausen", "Neugeborenes im Tragetuch in Villingen", "Baby at pediatrician in Stockach",
    "Newborn with baby shoes in Zurich", "Baby with pacifier in Winterthur", "Neugeborenes im Kinderwagen in Überlingen",
    "Baby mit Mütze in Friedrichshafen", "Newborn in baby carrier in Singen", "Neugeborenes mit Babymütze in Radolfzell",
    "Baby with first tooth in Konstanz", "Neugeborenes im Schlafsack in Kreuzlingen", "Baby's first Christmas in Rottweil",
    "Newborn with baby bottle in Schaffhausen", "Neugeborenes im Laufgitter in Villingen", "Baby with first steps in Stockach",
    "Newborn and toddler sibling in Zurich", "Baby mit Spieluhr in Winterthur", "Neugeborenes und Kleinkind in Überlingen",
    ...
    "Newborn with Christmas tree in Schaffhausen", "Neugeborenes und Weihnachtsbaum in Villingen", "Baby mit Geschenk in Stockach",
    "Newborn with Christmas tree in Schaffhausen", "Neugeborenes und Weihnachtsbaum in Villingen", "Baby mit Geschenk in Stockach",
    "Neugeborenes mit Familienhund in Singen", "Newborn with pet cat in Radolfzell", "Baby im ersten Outfit in Konstanz",
    ...
    "Baby und Eltern beim Arzt in Singen", "Newborn and parents at doctor in Radolfzell", "Baby’s erste Reise in Konstanz",
    "Newborn’s first trip in Kreuzlingen", "Baby mit Oma und Opa in Rottweil", "Newborn with grandparents in Schaffhausen",
...
alt_tags_babybauch = [
    ...
    "Schwangere Frau in Konstanz", "Baby bump in Konstanz", "Schwangerschaft in Kreuzlingen", "Pregnancy in Kreuzlingen",
    ...
    "Paar erwartet Baby in Stockach", "Couple expecting in Stockach", "Schwangere mit Buch in Zurich", "Pregnant reading in Zurich",
    "Schwanger im Sommer in Winterthur", "Pregnant in summer in Winterthur", "Schwanger am Bodensee in Überlingen",
    "Pregnant at Bodensee in Überlingen", "Schwangere im Park in Friedrichshafen", "Pregnant in park in Friedrichshafen",
    ...
    "Babybauch im Winter in Überlingen", "Maternity in winter in Überlingen", "Schwangerschaft und Sport in Friedrichshafen",
    ...
    "Schwanger in der Küche in Schaffhausen", "Pregnant in the kitchen in Schaffhausen", "Schwangerschaft und Ernährung in Villingen",
    "Pregnancy and nutrition in Villingen", "Schwangerschaft und Familie in Stockach", "Pregnancy and family in Stockach",
    "Babybauch und Musik in Zurich", "Maternity and music in Zurich", "Schwanger im Frühling in Winterthur",
    "Pregnant in spring in Winterthur", "Schwangerschaft und Freizeit in Überlingen", "Pregnancy and leisure in Überlingen",
    "Schwanger und Wellness in Friedrichshafen", "Pregnant and wellness in Friedrichshafen", "Babybauch und Spaß in Singen",
    ...
    "Babybauch und Wochenende in Villingen", "Maternity and weekend in Villingen", "Schwangerschaft und Gesundheit in Stockach",
    "Pregnancy and health in Stockach", "Schwanger und Tanzen in Zurich", "Pregnant and dancing in Zurich",
    "Babybauch und Kochen in Winterthur", "Maternity and cooking in Winterthur", "Schwangerschaft und Spaziergang in Überlingen",
    "Pregnancy and walk in Überlingen", "Schwanger und Sonnenuntergang in Friedrichshafen", "Pregnant and sunset in Friedrichshafen",
    "Babybauch und Erholung in Singen", "Maternity and rest in Radolfzell", "Schwanger und Frühstück in Konstanz",
    "Pregnant and breakfast in Konstanz", "Babybauch und Abendessen in Kreuzlingen", "Maternity and dinner in Kreuzlingen",
    ...
    "Schwangerschaft und Dorf in Überlingen", "Pregnancy and village in Überlingen", "Schwanger und Wald in Friedrichshafen",
...
alt_tags_baby = [
    ...
    "1-jähriges Kind in Konstanz", "1-year-old in Konstanz", "Cakesmash Fotoshooting in Kreuzlingen", "Cakesmash photoshoot in Kreuzlingen",
    "Baby beim Krabbeln in Rottweil", "Crawling baby in Rottweil", "Kleinkind mit Spielzeug in Schaffhausen", "Toddler with toy in Schaffhausen",
    "Baby mit Eltern in Villingen", "Baby with parents in Villingen", "Kleinkind beim Malen in Stockach", "Toddler painting in Stockach",
    "Baby beim Schlafen in Zurich", "Sleeping baby in Zurich", "2-jähriges Kind in Winterthur", "2-year-old in Winterthur",
    "Kleinkind im Garten in Überlingen", "Toddler in garden in Überlingen", "Baby beim Essen in Friedrichshafen", "Eating baby in Friedrichshafen",
    "1. Geburtstag in Singen", "1st birthday in Radolfzell", "Baby mit Hund in Konstanz", "Baby with dog in Konstanz",
    "Kleinkind und Katze in Kreuzlingen", "Toddler with cat in Kreuzlingen", "Kleinkind beim Spielen in Rottweil", "Toddler playing in Rottweil",
    "Baby mit Großeltern in Schaffhausen", "Baby with grandparents in Schaffhausen", "Kleinkind beim Lesen in Villingen", "Toddler reading in Villingen",
    "Baby beim Baden in Stockach", "Bathing baby in Stockach", "Kleinkind beim Essen in Zurich", "Toddler eating in Zurich",
    "Baby beim Spazieren in Winterthur", "Strolling baby in Winterthur", "Kleinkind im Zoo in Überlingen", "Toddler at zoo in Überlingen",
    "Baby mit Bruder in Friedrichshafen", "Baby with brother in Friedrichshafen", "Kleinkind mit Schwester in Singen", "Toddler with sister in Radolfzell",
    "Baby im Hochstuhl in Konstanz", "Baby in highchair in Konstanz", "Kleinkind in der Schule in Kreuzlingen", "Toddler at school in Kreuzlingen",
    "Baby beim Arzt in Rottweil", "Baby at doctor in Rottweil", "Kleinkind im Park in Schaffhausen", "Toddler at park in Schaffhausen",
    "Baby beim Schwimmen in Villingen", "Swimming baby in Villingen", "Kleinkind beim Tanzen in Stockach", "Dancing toddler in Stockach",
    "Baby im Auto in Zurich", "Baby in car in Zurich", "Kleinkind auf dem Fahrrad in Winterthur", "Toddler on bike in Winterthur",
    "Baby im Flugzeug in Überlingen", "Baby in airplane in Überlingen", "Kleinkind im Boot in Friedrichshafen", "Toddler in boat in Friedrichshafen",
    "Baby beim Singen in Singen", "Singing baby in Radolfzell", "Kleinkind beim Musizieren in Konstanz", "Musical toddler in Konstanz",
    "Baby beim Cakesmash in Kreuzlingen", "Cakesmash baby in Kreuzlingen", "Kleinkind beim Backen in Rottweil", "Baking toddler in Rottweil",
    "Baby mit Mutter in Schaffhausen", "Baby with mother in Schaffhausen", "Kleinkind mit Vater in Villingen", "Toddler with father in Villingen",
    "Baby mit Schnuller in Stockach", "Baby with pacifier in Stockach", "Kleinkind mit Flasche in Zurich", "Toddler with bottle in Zurich",
    "Baby mit Mütze in Winterthur", "Baby with hat in Winterthur", "Kleinkind mit Schuhen in Überlingen", "Toddler with shoes in Überlingen",
    "Baby mit Strampler in Friedrichshafen", "Baby in onesie in Friedrichshafen", "Baby im Sommer in Singen", "Summer baby in Radolfzell", "Kleinkind im Herbst in Konstanz", "Autumn toddler in Konstanz",
    "Baby mit Teddybär in Kreuzlingen", "Baby with teddy bear in Kreuzlingen", "Kleinkind im Schnee in Rottweil", "Snowy toddler in Rottweil",
    "Baby im Blumenfeld in Schaffhausen", "Baby in flower field in Schaffhausen", "Kleinkind auf der Rutsche in Villingen", "Toddler on slide in Villingen",
    "Baby im Sandkasten in Stockach", "Baby in sandbox in Stockach", "Kleinkind beim Klettern in Zurich", "Toddler climbing in Zurich",
    "Baby im Streichelzoo in Winterthur", "Baby in petting zoo in Winterthur", "Kleinkind beim Fischen in Überlingen", "Toddler fishing in Überlingen",
    "Baby im Einkaufszentrum in Friedrichshafen", "Baby in shopping mall in Friedrichshafen", "Kleinkind im Restaurant in Singen", "Toddler in restaurant in Radolfzell",
    "Baby beim Zahnarzt in Konstanz", "Baby at the dentist in Konstanz", "Kleinkind mit Bauklötzen in Kreuzlingen", "Toddler with building blocks in Kreuzlingen",
    "Baby mit Luftballons in Rottweil", "Baby with balloons in Rottweil", "Kleinkind beim Malen in Schaffhausen", "Toddler drawing in Schaffhausen",
    "Baby mit Kuscheltier in Villingen", "Baby with stuffed animal in Villingen", "Kleinkind mit Puzzle in Stockach", "Toddler with puzzle in Stockach",
    "Baby mit Lätzchen in Zurich", "Baby with bib in Zurich", "Kleinkind mit Töpfchen in Winterthur", "Toddler with potty in Winterthur",
    "Baby mit Milchflasche in Überlingen", "Baby with milk bottle in Überlingen", "Kleinkind mit Schnuffeltuch in Friedrichshafen", "Toddler with security blanket in Friedrichshafen"
]