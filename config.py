...
pakets = (
    ('- MINI -', '349,-',
     """1-2 Kulissen | Fotoshooting ca. 1.5 Std. | 8 bearbeitete und voll retuschierte Fotos als Download | 
     Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- STANDART -', '449,-',
     """2-3 Kulissen | Fotoshooting ca. 2 Std. | Familien- und Geschwisterfoto inkl. | 
     15 bearbeitete und voll retuschierte Fotos als Download | Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- MAXI -', '549,-',
     """3-4-5 Kulissen | Familien- und Geschwisterfoto inkl. | 20 bearbeitete und voll retuschierte Fotos als Download + Fotoabzug | 
      Alle Fotos vom Fotoshooting als Download | Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- BABYFOTOS (5-24 MONATE) MINI -', '349,-',
     """* Torte ist nicht im Preis enthalten und muss mitgebracht werden | 2 Kulissen | 
     8 bearbeitete und voll retuschierte Fotos als Download | Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- BABYFOTOS (5-24 MONATE) Standart -', '449,-',
     """* Torte ist nicht im Preis enthalten und muss mitgebracht werden | 3 Kulissen + Familien- und Geschwisterfoto | 
     15 bearbeitete und voll retuschierte Fotos als Download | 
     Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- BABYFOTOS (5-24 MONATE) MAXI -', '549,-',
     """* Torte ist nicht im Preis enthalten und muss mitgebracht werden | 4 Kulissen | 
     Familien- und Geschwisterfoto inkl. | 20 bearbeitete und voll retuschierte Fotos als Download | 
      Alle Fotos vom Fotoshooting | Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- Babybauch MINI -', '299,-',
     """max. 3 Outfitswechsel (10,- EUR pro Kleid, falls ausgeliehen) |  Familien- und Geschwisterfoto inkl. | 10 Bilder sind inklusive (hochauflösendes als digital download) | 
     Jedes weitere Bild kann als Datei für 15,- EUR erworben werden | Passwortgeschützte Online Galerie zur Auswahl der Bilder"""),

    ('- Babybauch Standart -', '349,-',
     """max. 5 Outfitswechsel (10,- EUR pro Kleid, falls ausgeliehen) |  Familien- und Geschwisterfoto inkl. | 15 Bilder sind inklusive (hochauflösendes als digital download) | 
     Jedes weitere Bild kann als Datei für 15,- EUR erworben werden | Passwortgeschützte Online Galerie zur Auswahl der Bilder""")
)
